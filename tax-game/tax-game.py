...
TOPICS = {
    ...
    "badr": {
        ...
        "plain": "when you sell your business (or shares in your own company), the CGT rate is 18% (up from 10% before Oct 2024, then 14% in April 2025, now 18% from April 2026) instead of 24%. up to £1M lifetime limit. formerly Entrepreneurs' Relief. you must have owned the business for 2+ years and been an officer/employee of the company.",
        "legislation": "Taxation of Chargeable Gains Act 1992, s.169I–169N; Finance Act 2026 (rate increase to 18%)",
        "loophole": "the £1M limit is per individual, not per business. a married couple who both hold shares can get £2M at 18%. gift shares to your spouse before sale to double the limit. also: Investors' Relief (s.169V) gives 18% on up to £10M for external investors who hold shares 5+ years. different relief, 10x the limit. CGT rates are now 18%/24% (from April 2026, up from 10%/20%). the rates are rising — plan disposals early.",
        "hmrc_filing": "claim on SA108 (capital gains pages). must claim by 31 Jan after the tax year of disposal (1 year after disposal). if you miss the deadline, you pay 24% instead of 18%.",
        "card_type": "spell",
        "card_rank": "SS",
    },
    "rd-tax-credits": {
    ...
    "iht-bpr": {
        ...
        "plain": "when you die, your estate pays 40% IHT on everything above £325,000 (or £500,000 with residence nil-rate, up to £1M for couples). BUT if you own a business or shares in a qualifying company, Business Property Relief gives 100% relief up to £2.5M (NEW — Finance Act 2026). Above £2.5M, relief drops to 50%. your £2.5M business passes tax-free. a £10M business now has £3.75M taxable at 40% = £1.5M IHT (previously £0).",
        "legislation": "Inheritance Tax Act 1984, s.104–113 (BPR); Finance Act 2026 s.124D — 100% relief capped at £2.5M combined BPR+APR allowance, 50% above",
        "loophole": "the £2.5M allowance is per individual. a married couple gets £5M at 100%. above that, 50% relief still applies. AIM shares held for 2+ years still qualify for BPR. an AIM ISA = ISA (no income tax, no CGT) + BPR (reduced IHT). the AIM ISA loophole is weakened but not killed — the first £2.5M is still 100% exempt. also: if 10%+ of net estate goes to charity, IHT rate drops from 40% to 36% (IHTA 1984 s.7). the charitable giving loophole survived the reform.",
