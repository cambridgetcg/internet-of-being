...
TAXES = {
    ...
    "capital-gains-tax": {
        ...
        "development": [
            ...
            "2024: BADR rate 10% (up to £1M lifetime). Annual exempt amount cut to £3,000 from £12,300.",
            "2025: CGT rates raised to 18%/24% (from 10%/20%). BADR raised to 14%.",
            "2026: BADR raised to 18% (Finance Act 2026). Investors' Relief also 18% (up to £10M). Annual exempt amount remains £3,000. The tax-free allowance was slashed 75% while rates doubled.",
        ],
        "vulnerability": "The annual exempt amount was slashed from £12,300 to £3,000 in 2023. CGT rates doubled from 10%/20% to 18%/24% in 2025-2026. BADR went from 10% to 18%. But bed-and-ISA still works: sell to realize gains within the exemption, rebuy inside ISA, all future gains tax-free. Also: spousal transfers are CGT-free (TCGA 1992 s.58). Gift shares to spouse before sale to double the exemption. Also: BADR gives 18% on £1M — but a married couple can get £2M at 18% if both hold shares. Also: Investors' Relief (s.169V) gives 18% on up to £10M. Also: crypto gains are CGT. The rates are rising — plan disposals early, use ISA wrapper aggressively.",
        "current_rate": "18% / 24% (from April 2026)",
    ...
    "inheritance-tax": {
        ...
        "vulnerability": "Only 4% of estates pay IHT. The other 96% avoid it through: (1) Business Property Relief — 100% relief up to £2.5M (NEW Finance Act 2026, s.124D), 50% above. Previously unlimited 100%. A married couple still gets £5M at 100%. (2) The 7-year rule — gifts become tax-free after 7 years. Gift early, gift often. (3) Spousal exemption — unlimited tax-free transfers between spouses. (4) Trusts — assets in trusts are outside the estate. (5) Agricultural Property Relief — shares the same £2.5M 100% allowance with BPR. (6) Charitable giving — 10%+ to charity drops rate from 40% to 36%. The vulnerability: IHT is still a voluntary tax for beings who plan. The 2026 reform weakened BPR but didn't kill it. The first £2.5M is still 100% exempt per person.",
        "current_rate": "40% above £325k (or £500k with RNRB). 36% if 10%+ to charity.",
        "current_revenue": "£7.6 billion (2023/24) — tiny, but feared. BPR reform will increase this.",
